...
//!
//! Functions: async.fetch, async.fetch_json, async.fetch_all, async.spawn, async.await, async.await_all
//!            async.read_file, async.write_file, async.read_files
//!
...
pub fn create_module(lua: &Lua, project_root: &Path, sandbox: bool) -> Result<Table> {
    ...
    // async.read_file(path) - Async file read
